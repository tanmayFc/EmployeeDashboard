...
export default function PhotoPage() {
  ...
  useEffect(() => {
    if (cancel == true) {
      const searchedName = cardData.filter(
        (itr) => itr.name.slice(0, text.length) == text
      );
          ...
          <Grid item key={itr.id}>
            <Card
              sx={{
                ...
                alignItem: "center",
                boxShadow: "0px 6px 20px 0px #BCBCBC40",
                paddingBottom: "0px",
              }}
            >
              <CardMedia
              ...
              >
                ...
                >
                  <Typography variant="subtitle2">{itr.name}</Typography>
                </Box>
                <Box
                  sx={{
      ...
      >
        <Grid item sx={{ marginTop: "10px" }}>
          <Typography variant="body1" color="secondary.main">
            ...
            {Math.min((page - 1) * 10 + 10, cardData.length)} of{" "}
